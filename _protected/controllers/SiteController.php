...
//------------------------------------------------------------------------------------------------//
    ...
    public function actionIndex()
    {
        ...
        $dataObatJson =  file_get_contents("./ref-obat.json");
        // $dataObat = Json::decode($dataObatJson, true);
        // $toPrint = [];
        // foreach ($dataObat as $key => $value) {
        //     $toPrint[] =  ['key' => $key, 'count' => count($value)];
        // }
        // return var_dump($toPrint);
        // return var_dump($dataObat['innmaster_union']);
        $dataObat = Json::decode($dataObatJson, false);
        $dataObatProvider = new ArrayDataProvider([
            'allModels' => $dataObat->drugsmaster_all,
            // 'allModels' => $dataObat->innmaster_union,
            // 'allModels' => $dataObat->drugsmaster_inn,
            // 'pagination' => ['pageSize' => 0]
        ]);
        // return var_dump($dataObatProvider->getModels());
        return $this->render('obat', compact('dataObatProvider'));

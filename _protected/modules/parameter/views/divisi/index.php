...
/* @var $searchModel app\modules\parameter\models\RefDivisiSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Ref Divisis';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="ref-divisi-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a('Tambah Ref Divisi', ['create'], [
            'class' => 'btn btn-xs btn-success',
            'role'=>'modal-remote',
            'title' => 'Tambah Ref Divisi',
        ]) ?>
    </p>
    <?= GridView::widget([
        'id' => 'ref-divisi',    
